    ...
    return (
      <div className="contenedor">
        ...
        <div className="contenido">
          ...
          <h5>Descripción:</h5>
          <p className="section_decoration body">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean sit
            amet ex ipsum. Ut auctor luctus ipsum, ut ullamcorper nunc finibus
            sed. Quisque non convallis nibh. In interdum ligula ac sapien semper
            blandit. Nulla nunc purus, ultricies quis elit et, accumsan
            dignissim augue. In eros dui, sagittis vel lobortis eu, volutpat sit
            amet sem. Pellentesque efficitur magna id ipsum cursus, sit amet
            tempor sem sollicitudin. Pellentesque suscipit facilisis eros
            fringilla faucibus. Morbi eget ullamcorper enim. Curabitur at ex et
            orci accumsan volutpat. Ut lobortis mattis diam at vestibulum.
            Aliquam sit amet ex a sem egestas mollis. Vivamus non ipsum dictum,
            ornare purus in, suscipit sem. Curabitur id vestibulum leo. Aliquam
            volutpat, orci eget iaculis feugiat, dui urna mattis diam, in
            accumsan felis velit ut libero. Aenean lobortis vehicula placerat.
          </p>
